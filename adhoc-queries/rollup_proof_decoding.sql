...
create table dune_user_generated.aztec_v2_proofs_cached (
  rollupId numeric,
  rollupSize numeric,
...
create
or replace function dune_user_generated.fn_process_aztec_block_row(data bytea) returns setof dune_user_generated.aztec_v2_proofs_cached as 
$$
declare 
...
--   ):: dune_user_generated.aztec_v2_proof_data_struct as result
-- from
--   _data;
end;

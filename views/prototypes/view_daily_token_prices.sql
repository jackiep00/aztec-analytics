-- Attempting to grab all of the token prices as a view - let's see how long it takes to run
-- on 2022-06-09, runtime of this was 2 minutes - perhaps tolerable

create view dune_user_generated.view_aztec_v2_daily_bridged_tokens_prices as
---------------------------------------------------------------------

drop view if exists dune_user_generated.view_aztec_v2_daily_deposits;

create or replace view dune_user_generated.view_aztec_v2_daily_deposits as 
...
, daily_volume as (
    ...
    inner join dune_user_generated.view_aztec_v2_daily_bridged_tokens_prices p on dt.date = p.date and dt.token_address = p.token_address
)
